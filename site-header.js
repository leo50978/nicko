      ...
      <header class="site-header-shell sticky top-0 z-50">
        <div class="container-shell py-3 md:py-4">
          <div class="site-header-bar flex min-h-[84px] items-center justify-between gap-4 px-4 py-3 md:px-6">
            <a href="${appHref("/index.html")}" class="site-brand site-brand-logo-shell site-brand-logo-shell-wide" aria-label="${t("nav.brand")}">
            ...
            <div class="hidden items-center gap-3 lg:flex">
              ${
                authed
                  ...
                  : `<a class="ui-button ui-button-secondary" href="${appHref("/login.html")}">${t("nav.login")}</a>
                     <a class="ui-button ui-button-primary" href="${appHref("/register.html")}">${t("nav.register")}</a>`
              }
            </div>
