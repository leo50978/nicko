    ...
    this.root.innerHTML = `
      <section class="section-space-tight">
        <div class="container-shell">
          <div class="cta-surface panel p-6 md:p-8" style="color: white;" data-motion-stagger>
            <div class="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
              <div class="max-w-[760px]" data-motion-item>
                <p class="ui-eyebrow text-white/65">${this.options.eyebrow || ""}</p>
                <h2 class="ui-title mt-3">${this.options.title || ""}</h2>
                <p class="ui-body mt-4 text-white/78">${this.options.description || ""}</p>
              </div>
